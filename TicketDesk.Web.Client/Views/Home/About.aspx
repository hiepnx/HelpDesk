...
<asp:Content ID="aboutContent" ContentPlaceHolderID="MainContent" runat="server">
    <% var controller = ViewContext.Controller as HelpDesk.Web.Client.Controllers.HomeController; %>
                ...
                <div class="displayContainerInner" style="width: 100%;">
                    <div>
                        ...
                        <div class="activityBody" style="padding: 15px; min-height: 200px;">
                            <p>
                                <a href="http://HelpDesk.codeplex.com">HelpDesk 2.1</a> is an open source project
                                hosted on <a href="http://codeplex.com">CodePlex</a>.
                            </p>
                            <p>
                                HelpDesk is designed to be a fully functional yet simplistic web based issue tracking system
                                with a focus on promoting frictionless communication between the help desk and
                                end-users. HelpDesk is designed primarily for internal use within a single organization. 
                            </p>
                            
                            <p>
                                HelpDesk was developed with the following technologies:
                            </p>
                            <ul>
