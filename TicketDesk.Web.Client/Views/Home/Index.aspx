<%@ Page Title="HelpDesk Home" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage" %>
                        ...
                        <tr>
                            <td style="vertical-align: top; background-color: #fff;">
                                <div style="padding: 10px;">
                                    <h2>Welcome to HelpDesk 2.1 <sup>(.Net 4.5 Refresh)</sup></h2>
                                    <p>
                                    ...
                                    <p>
                                        There are three pre-defined example users in a default HelpDesk 2.0 distribution:
                                    </p>
                                    <ul>
