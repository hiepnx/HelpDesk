...
<div class="activityBody">
    <% using (Ajax.BeginForm(MVC.TicketEditor.ActionNames.RequestMoreInfo, new { ID = Model.TicketId }, new AjaxOptions { UpdateTargetId = "activityArea", OnBegin = "beginChangeActivity", OnSuccess = "completeModifyTicketActivityAndDetails", OnFailure = "failModifyTicketActivity" }, new { defaultbutton = "requestInfoButton", @Class = "editForm" }))
       {
    %>
    ...
    <input id="requestInfoButton" type="submit" value="Request Info" class="activityButton"
