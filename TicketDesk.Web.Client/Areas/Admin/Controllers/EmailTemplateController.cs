...
namespace HelpDesk.Web.Client.Areas.Admin.Controllers
{
    ...
    public partial class EmailTemplateController : ApplicationController
    {
        ...
        private HelpDesk.Domain.Services.NotificationSendingService noteService { get; set; }
        ...
        {
            var ticketService = new TicketService(Security, new TicketRepository(), null, null);
