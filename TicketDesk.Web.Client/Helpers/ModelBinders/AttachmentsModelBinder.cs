...
{
    public class AttachmentsModelBinder : DefaultModelBinder
    {
        #region IModelBinder Members

        public override object BindModel(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
            return GetFilesFromForm(controllerContext);
        }

        #endregion

        protected object BindFromDefaultModelBinder(ControllerContext controllerContext, ModelBindingContext bindingContext)
        {
