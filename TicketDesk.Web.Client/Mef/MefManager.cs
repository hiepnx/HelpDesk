...
using HelpDesk.Web.Client.Areas.Admin.Controllers;
using HelpDesk.Domain.Services.Base;

namespace HelpDesk.Web.Client
{
    public class MefManager
    {
        ...
        protected string TicketNotificationHtmlEmailContent(HelpDesk.Domain.Models.TicketEventNotification notification, int firstUnsentCommentId)
        {
        ...
        protected string TicketNotificationTexxtEmailContent(HelpDesk.Domain.Models.TicketEventNotification notification, int firstUnsentCommentId)
        {
            var controller = new EmailTemplateController();
